...
export const messages: Messages = {
  ...
  category: {
    ...
    hideTitle: 'Ocultar Categoria',
    hideConfirm: 'Tem certeza que deseja ocultar a categoria "{name}"?',
    hideNote: 'Transações existentes com esta categoria serão mantidas.',
    hide: 'Ocultar',
  },
