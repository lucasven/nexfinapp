...
export const messages: Messages = {
  ...
  paymentMethods: {
    ...
    editSuccess: 'Método de pagamento atualizado com sucesso',
  ...
  paymentDueSettings: {
    ...
    paymentDayPlaceholder: 'Selecione o dia',
    daysBeforeClosing: 'Dias antes do pagamento para fechamento',
    daysBeforeClosingPlaceholder: 'Ex: 7 dias',
    calculatedClosing: 'Fechamento calculado',
    ...
    saveButton: 'Salvar',
    successToast: 'Vencimento configurado com sucesso',
    errorToast: 'Erro ao salvar configuração. Tente novamente.',
    validationError: 'Dia de pagamento deve ser entre 1 e 31',
    closingDayRequired: 'Configure o dia de pagamento primeiro',
    setClosingDayButton: 'Configurar Dia de Pagamento',
    description: 'Defina o dia do mês em que você paga a fatura e quantos dias antes ela fecha',
    helpText: 'Exemplo: se você paga dia 1 e a fatura fecha 7 dias antes, o fechamento será dia 25 do mês anterior',
  },
