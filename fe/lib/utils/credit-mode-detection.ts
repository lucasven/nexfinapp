/**
 * Credit Mode Detection Utility (Frontend)
 *
 * Shared detection logic for determining if a payment method requires
 * credit mode selection before completing a transaction.
 *
 * Story: 1-2-first-credit-card-transaction-detection
 * Acceptance Criteria: AC2.1 - Detection Logic for Unset Mode
 */
